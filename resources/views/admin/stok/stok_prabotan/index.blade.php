...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Product Prabotan</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin') }}">admin</a></li>
                    <li class="breadcrumb-item active">Prabotan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">Prabotan</span></h5>
                            ...
                            @foreach ($prabotan as $pra)
                                <tr>
                                    ...
                                    {{-- <td>
                                        ...
                                        <form method="POST" action="{{ route('obat.destroy', $pra->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="custom-btn custom-btn-merah">Hapus</button>

                                            <a class="custom-btn" href="{{ url('obat-edit', $pra->id) }}">Edit</a>
                                        </form>
                                    </td> --}}
                                </tr>
                            @endforeach
